...
* 不提供任何明示或暗示的保证或条件。有关许可的具体语言、权限和限制，请参阅许可证。*/
...
public class SimplePropertyDescriptorTests {
    ...
    public void toStringOutput() throws IntrospectionException, SecurityException, NoSuchMethodException {
        ...
        }
        {
            ...
            assertThat(pd.toString()).contains("PropertyDescriptor[name=foo", "propertyType=class java.lang.String", "readMethod=null, writeMethod=public java.lang.Object");
        }
        {
        ...
        }
        {
            ...
            assertThat(pd.toString()).contains("PropertyDescriptor[name=foo, propertyType=null", "indexedPropertyType=class java.lang.String", "indexedWriteMethod=public java.lang.Object");
        }
    }
