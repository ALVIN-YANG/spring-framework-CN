...
public class TestBean implements BeanNameAware, BeanFactoryAware, ITestBean, IOther, Comparable<Object> {
     ...
     * 翻译为中文为：
     * @see org.springframework.beans.testfixture.beans.ITestBean#exceptional(Throwable)（请参见 org.springframework.beans.testfixture.beans.ITestBean 类的 exceptional 方法）
     */
    @Override
    ...
    /**
     * @see org.springframework.beans.testfixture.beans.ITestBean#returnsThis() 翻译为中文为：
     * @see org.springframework.beans.testfixture.beans.ITestBean#returnsThis() 请参考 org.springframework.beans.testfixture.beans.ITestBean 类的 returnsThis() 方法。
     */
    @Override
     ...
     * @see 用于引用其他类或方法的文档注释，这里的注释引用了 `org.springframework.beans.testfixture.beans.IOther` 类中的 `absquatulate()` 方法。翻译成中文为：
     * @see org.springframework.beans.testfixture.beans.IOther#absquatulate()
     * @see 请参考 org.springframework.beans.testfixture.beans.IOther 类中的 absquatulate() 方法
     */
    @Override
    ...
    public boolean equals(@Nullable Object other) {
        return (this == other || (other instanceof TestBean that && ObjectUtils.nullSafeEquals(this.name, that.name) && this.age == that.age));
    }
